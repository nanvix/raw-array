...
This repository provides an array container abstraction that may be instantiated on top of either a rust-managed or user-managed memory region.

This abstraction is used in the Nanvix operating system to construct more complex data structures.
